...
public class ConcertOptionUnitTest {
    ...
    @Test
    @DisplayName("콘서트_좌석_생성")
    void Concert_콘서트_좌석_생성() {
        // given
        Long concertId = 1L;
        Long concertOptionId = 1L;
        Integer price = 10000;
        ...
        // when
        concertOption.createSeat();

        // then
        assertEquals(ConcertOption.DEFAULT_SEAT_QUANTITY, concertOption.getSeats().size());
    }
}
